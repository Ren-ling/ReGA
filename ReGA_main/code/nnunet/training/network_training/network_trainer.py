...
class NetworkTrainer(object):
    ...
    def do_split(self):
        ...
        if not isfile(splits_file):
            ...
            # 初始化 K 折交叉验证，设置 5 折，随机打乱，固定随机种子为 12345
            kfold = KFold(n_splits=5, shuffle=True, random_state=12345)
            # # 遍历 K 折交叉验证的每一折，获取训练和验证索引
    ...
    def on_epoch_end(self):
        ...
        # metrics 更新
        # 2025-11-11 20:43:24.874454:
        # Val glob dc per class: [0.8957344899253027, 0.9426959313081733, 0.9420822261865425, 0.8867338489858982]
        ...
        self.update_eval_criterion_MA()  # 更新验证评估指标的 EMA

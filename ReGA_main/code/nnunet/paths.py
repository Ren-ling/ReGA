...
Server_Base_Path = "/mnt/newdisk/CTPelvic1k/all_data"

# You need to set the following folders: base, preprocessing_output_dir and network_training_output_dir. See below
# for details.

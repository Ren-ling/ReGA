...
if __name__ == "__main__":
    ...
    test_dir = r"/mnt/newdisk/CTPelvic1k/raw_data/Test"
    ...
    #     patient_id = filename.replace("train_", "", 1).replace("_0000.nii.gz", "")
    #     pat_id = "train_" + patient_id
    ...
    #     data_file = args
    #     filename = os.path.basename(data_file)
    #     patient_id = filename.replace("_data.nii.gz", "")
    #     pat_id = "test_" + patient_id
    #     shutil.copy(data_file, join(img_dir_te, pat_id + "_0000.nii.gz"))
    #     return pat_id
    ...
    # nii_files_tr_seg = subfiles(train_dir, True, None, ".nii.gz", True)

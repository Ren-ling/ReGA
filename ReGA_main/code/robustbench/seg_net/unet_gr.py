...
class UNet_gr(nn.Module):
    def __init__(self, params):
        super(UNet_gr, self).__init__()
        """
        UNet autoencoder
        """
        self.params = params
        ...
        self.norm = 'batchnorm'
        self.ndf = 16
        self.upsample = self.params['bilinear']
        self.in_channel = self.params['in_chns']
        ...
        self.classifier_conv = nn.Conv2d(self.ndf, 16, 3, 1, 1, 1)

        self.final_conv1 = conv_in_lrelu(16, 16, 3, 1, 1)
        self.final_conv2 = conv_in_lrelu(16, 16, 3, 1, 1)
        self.pred = nn.Conv2d(16, self.num_classes, 1, 1, 0)

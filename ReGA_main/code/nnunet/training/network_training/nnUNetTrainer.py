...
# 在/home/hello/code_rl/CTPelvic1K-main/nnunet/network_architecture/generic_UNet、neural_network
...
class nnUNetTrainer(NetworkTrainer):
    ...
    self.initialize:          init the trainer
        ...
        self.initialize_network_optimizer_and_scheduler: network, optimizer(Adam),lr_scheduler.ReduceLROnPlateau and
        set "self.network.inference_apply_nonlin = softmax_helper"

    self.run_training: patient class method # 核心训练方法
        empty cuda cache
        ...
        # run_iteration 是训练的主要部分，处理损失计算和检查点保存
    ...
    def predict_preprocessed_data_return_softmax(self, data, do_mirroring, num_repeats, use_train_mode, batch_size,
        ...
        todo:??? :param data: :param do_mirroring: :param num_repeats: :param use_train_mode: :param batch_size:
        :param mirror_axes: :param tiled: :param tile_in_z: :param step: :param min_size: :param use_gaussian: :param
        use_temporal: :return:
        """
